...
def analyze_day():
    ...
    def show_hourly_usage_linechart_day():
        ...
        date = cal.get_date()
        try:
            startDate = cal.selection_get().strftime("%Y%m%d")
        except ValueError:
            try:
...
def show_fronius_sum():
    try:
        start_date = start_date_entry_cal.selection_get().strftime("%d.%m.%Y")
        end_date = end_date_entry_cal.selection_get().strftime("%d.%m.%Y")
    except ValueError:
        try:
            start_date = datetime.strptime(start_date_entry_cal.get_date(), "%d.%m.%Y").strftime("%d.%m.%Y")
            end_date = datetime.strptime(end_date_entry_cal.get_date(), "%d.%m.%Y").strftime("%d.%m.%Y")
        except ValueError:
